...
import BACKENDS from "./v1/backends/index.js";
import { Versions } from "./v1/backends/versions.js";
import { mergeReleaseNotes } from "./v1/utils/notes.js";
import {
  platforms,
  detectPlatform,
  resolveForVersion,
} from "./v1/utils/platforms.js";
import { parseRELEASES, generateRELEASES } from "./v1/utils/win-releases.js";

import { GitHubBackend, GithubArtifact } from "./v2/backends/GithubBackend.js";
...
export class Pecans {
  ...
  constructor(opts = {}) {
    ...
    this.githubBacked = new GitHubBackend(this.opts);
    ...
    this.router.get("/v2/api/versions", this.hookApi.bind(this), (...args) =>
      this.handleV2ApiVersions(...args)
    );
  ...
  async handleV2ApiVersions(req, res, next) {
    try {
      const versions = await this.githubBacked.getArtifacts();
      res.send(versions);
    } catch (err) {
      next(err);
    }
